...
{
	/// <summary>This class manages the main Paint in Editor window.
	/// This can be opened via <b>Window/Paint in Editor</b>, or from the Scene tab editor tool dropdown's <b>Paint in Editor</b> tool.</summary>
	public partial class CwPaintInEditor
	{
		...
		private static Rect DrawIcon(int size, Texture icon, string name, bool selected, string title = null)
		{
